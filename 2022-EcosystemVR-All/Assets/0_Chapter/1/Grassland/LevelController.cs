...
public class LevelController : MonoBehaviour
{
    ...
    public void ShowFirstQuestion()
    {
        ...
        if (ChNum == 0)
        {
            StartCoroutine(web.php(GlobalSet.SID, "10", "3", WebPhp.php_method.Action));
            ThermometerText.text = TemAndRainArr[ChNum][0];
            RainText.text = TemAndRainArr[ChNum][1];
        }
        else if (ChNum == 1)
        {
            StartCoroutine(web.php(GlobalSet.SID, "10", "9", WebPhp.php_method.Action));
            ThermometerText.text = TemAndRainArr[ChNum][0];
            RainText.text = TemAndRainArr[ChNum][1];
        }
        TargetText.text = QuestionArr[ChNum][QuestionCount];
    ...
    public void CheckAnswer()
    {
        if (EventSystem.current.currentSelectedGameObject.GetComponentInChildren<Text>().text == AnswerArr[ChNum][QuestionCount])
        {
            ...
            if (QuestionCount + 1 < QuestionArr[ChNum].Length)
            {
                ...
                {
                    StartCoroutine(web.php(GlobalSet.SID, "10", "4", WebPhp.php_method.Action));
                    CheckAnimal();
                ...
                {
                    StartCoroutine(web.php(GlobalSet.SID, "10", "10", WebPhp.php_method.Action));
                    CheckAnimal();
                ...
                {
                    StartCoroutine(web.php(GlobalSet.SID, "10", "20", WebPhp.php_method.Action));
                    CheckAnimal();
                    AnsButton1.SetActive(false);
                    AnsButton2.SetActive(false);
                    AnsButton3.SetActive(false);
                ...
                {
                    StartCoroutine(web.php(GlobalSet.SID, "10", "23", WebPhp.php_method.Action));
                    CheckAnimal();
                    AnsButton1.SetActive(false);
                    AnsButton2.SetActive(false);
                    AnsButton3.SetActive(false);
                ...
                {
                    StartCoroutine(web.php(GlobalSet.SID, "10", "27", WebPhp.php_method.Action));
                    CheckAnimal();
                    AnsButton1.SetActive(false);
                    AnsButton2.SetActive(false);
                    AnsButton3.SetActive(false);
                ...
                {
                    StartCoroutine(web.php(GlobalSet.SID, "10", "33", WebPhp.php_method.Action));
                    CheckAnimal();
                    AnsButton1.SetActive(false);
                    AnsButton2.SetActive(false);
                    AnsButton3.SetActive(false);
    ...
    public void CheckAnimalFeature(string Feature)
    {
        if (ChNum == 0 || ChNum == 1)
        {
            if (Feature == "LionHair")
            {
                StartCoroutine(web.php(GlobalSet.SID, "10", "7", WebPhp.php_method.Action));
                InfoText.text = "通常只有雄性的獅子脖子上會有鬃毛，是為了可以在打鬥中保護自己的頭部和脖子。";
                LionHair = true;
            }
            if (Feature == "LionTeeth")
            {
                StartCoroutine(web.php(GlobalSet.SID, "10", "8", WebPhp.php_method.Action));
                InfoText.text = "雄性獅子會有銳利的牙齒以及爪子，方便牠們狩獵使用。";
                LionTeeth = true;
            }
            if (Feature == "ZebraLines")
            {
                StartCoroutine(web.php(GlobalSet.SID, "10", "5", WebPhp.php_method.Action));
                InfoText.text = "斑馬身上的黑白紋路可以混淆斑馬的天敵的視覺，讓他沒辦法鎖定獵物。同時黑白相間的紋路還可以調節身體的溫度呢！";
                ZebraLines = true;
            }
            if (Feature == "ZebraFoot")
            {
                StartCoroutine(web.php(GlobalSet.SID, "10", "6", WebPhp.php_method.Action));
                InfoText.text = "斑馬的蹄可以讓牠在草原環境裡更快速的移動，避免被牠的天敵獵捕。";
                ZebraFoot = true;
            }
            if (Feature == "BearHair")
            {
                StartCoroutine(web.php(GlobalSet.SID, "10", "11", WebPhp.php_method.Action));
            ...
            {
                StartCoroutine(web.php(GlobalSet.SID, "10", "12", WebPhp.php_method.Action));
            ...
            {
                StartCoroutine(web.php(GlobalSet.SID, "10", "13", WebPhp.php_method.Action));
    ...
    {
        StartCoroutine(web.php(GlobalSet.SID, "10", "1", WebPhp.php_method.Action));
        ChNum = 0;
        InfoText.text = "";
    ...
    {
        StartCoroutine(web.php(GlobalSet.SID, "10", "2", WebPhp.php_method.Action));
        ChNum = 1;
        InfoText.text = "";
    ...
    public void Game()
    {
        StartCoroutine(web.php(GlobalSet.SID, "10", "14", WebPhp.php_method.Action));
